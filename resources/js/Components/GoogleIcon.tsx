export function GoogleIcon() {
    return (
        <svg className="h-4 w-4" viewBox="0 0 48 48" aria-hidden="true">
            ...
            <path fill="#4CAF50" d="M24 44c5.5 0 10.5-2.1 14.3-5.5l-6.6-5.6c-2 1.5-4.6 2.5-7.7 2.5-5.2 0-9.6-3.3-11.3-7.9l-6.5 5C9.9 39.7 16.4 44 24 44z" />
            <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4.1 5.6l6.6 5.6C41.9 35.6 44 30.2 44 24c0-1.3-.1-2.7-.4-3.5z" />
        </svg>
    );
}

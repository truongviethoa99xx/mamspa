...
export interface CategoryClosingData {
    heading?: unknown;
    body?: unknown;
    ctaText?: unknown;
    ctaLink?: string | null;
...
/**
 * Banner CTA khép lại trang danh mục dịch vụ (`/dich-vu/{category}/`). Tách riêng
 * khỏi `ServicesClosing` (dùng cho trang `/dich-vu/`) để chỉnh spacing độc lập,
 * không ảnh hưởng trang danh sách dịch vụ.
 */
export function CategoryClosing({ data }: { data: CategoryClosingData }) {

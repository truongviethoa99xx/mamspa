                        ...
                        >
                            ...
                            {data.video_url && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="group relative flex aspect-[4/3] shrink-0 basis-full snap-start items-center justify-center overflow-hidden rounded-xl bg-[#2F3E2E] shadow-sm sm:basis-[calc((100%-1.25rem)/2)] sm:rounded-2xl lg:basis-[calc((100%-2.5rem)/3)]"
                                >
                                    <span className="absolute inset-0 bg-gradient-to-t from-black/50 to-black/10" />
                                    <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-maha-50/90 text-[#2F3E2E] transition-transform group-hover:scale-105">
                                        <Play className="h-6 w-6 translate-x-0.5" fill="currentColor" />
                                    </span>
                                    <span className="absolute bottom-4 left-4 right-4 text-left text-sm font-semibold text-maha-50">
                                        {t('blocks.testimonial.video')}
                                    </span>
                                </a>
                            )}
                        </div>

...
>
    <div
        ...
        x-cloak
        style="position: fixed; inset: 0; z-index: 9999; display: flex; align-items: center; justify-content: center; background: rgba(30, 27, 20, 0.55); backdrop-filter: blur(2px);"
    >

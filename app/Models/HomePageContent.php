...
class HomePageContent extends Model
{
    protected $fillable = [
        ...
        'reviews_google_link',
        'reviews_tripadvisor_rating',
        'reviews_tripadvisor_count',
        'reviews_tripadvisor_link',
        ...
        'art_banner_cta_text',
        'art_banner_cta_link',
        'art_banner_cta_text_color',
        'art_banner_image',
        'art_banner_image_alt',
        'art_banner_visible',
        'spaces_title',
        'spaces_items',
        'spaces_visible',
    ...
    protected $casts = [
        ...
        'featured_services_heading' => 'array',

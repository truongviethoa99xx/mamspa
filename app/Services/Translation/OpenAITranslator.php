    ...
    public function translate(string $text, string $to, string $from = 'vi'): string
    {
        ...
        $response = Http::withToken($key)
            ...
            ->post(config('translation.openai.endpoint'), [
                ...
                'temperature' => 0,
                'messages' => [
                    ['role' => 'system', 'content' => "Translate from {$fromName} to {$toName}. Return ONLY the translation, no quotes or commentary. Keep brand names like 'Mầm Spa', 'Mầm Spa Lê Văn Sỹ', 'Mầm Spa Lê Thị Riêng' unchanged."],

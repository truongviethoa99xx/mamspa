...
import { P as PublicLayout } from "./PublicLayout-DcVNGTbq.js";
import { H as Hero } from "./Hero-CQyGpm3c.js";
import { a as createLucideIcon, u as useLocale, t as tr, c as cn, s as stripTags } from "./useLocale-BmHf4IVt.js";
import { u as useReveal, a as useReducedMotion } from "./useReveal-M9MvkmvG.js";
import { A as ArrowRight } from "./arrow-right-zQXHryNU.js";
import { S as Star } from "./star-B-cS1jOg.js";
import { D as Droplet, F as Flower2 } from "./flower-2-f4rK0b4-.js";
import { a as Sun, S as Sprout } from "./sun-CT5Rf_zU.js";
...
function Story({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        data.image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: data.image, alt: imageAlt, className: "absolute inset-0 z-0 h-full w-full object-cover" }),
...
const GO_TO_LABEL = { vi: "Đi tới dịch vụ", en: "Go to service" };
function FeaturedServices({ data }) {
  ...
  }, [(_a = data.services) == null ? void 0 : _a.length]);
  if (!((_b = data.services) == null ? void 0 : _b.length)) {
    return null;
  }
  const goToLabel = GO_TO_LABEL[locale] ?? GO_TO_LABEL.vi;
  const renderCard = (service, index, forCarousel) => {
    var _a2;
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: data.services.map((service, index) => renderCard(service, index, true))
          }
        ),
        canScroll && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex items-center justify-center gap-2 lg:hidden", children: data.services.map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 hidden lg:grid lg:grid-cols-4 lg:gap-x-6 lg:gap-y-10", children: data.services.map((service, index) => renderCard(service, index, false)) })
      ] })
    }
  );
}
function ArtBanner({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref, className: cn(className, "bg-maha-50"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-[4/3] bg-maha-200 md:aspect-auto", children: data.image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: data.image, alt: imageAlt, className: "absolute inset-0 h-full w-full object-cover" }) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
        ...
        ) : video.embed_url ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
            src: video.embed_url,
...
function BookingStrip({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { ref, className: cn(className, "relative overflow-hidden bg-maha-800"), children: [
    data.image && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: data.image, alt: "", className: "absolute inset-0 h-full w-full object-cover" }),
...
function Home({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Se, { title: "Trang chủ", children: [
      ...
      hero.image && /* @__PURE__ */ jsxRuntimeExports.jsx("link", { rel: "preload", as: "image", href: hero.image, fetchPriority: "high" })
    ] }),

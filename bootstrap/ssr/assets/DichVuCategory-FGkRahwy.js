...
import { u as useLocale, t as tr, c as cn, s as stripTags, a as truncate } from "./useLocale-CGFjb2L7.js";
import { C as CategoryHero } from "./CategoryHero-EgN955Kt.js";
import { GraduationCap, Leaf, HandHeart, Quote, Check, ArrowRight } from "lucide-react";
...
function CategoryIntro({ data }) {
  ...
  return /* @__PURE__ */ jsx("section", { ref, className: cn(className, "mt-1 bg-[#f5f2ed]"), children: /* @__PURE__ */ jsxs("div", { className: "grid lg:h-[440px] lg:grid-cols-2", children: [
    /* @__PURE__ */ jsx("div", { className: cn("aspect-[4/3] w-full lg:aspect-auto lg:h-[440px]", !hasImage && "bg-maha-200"), children: hasImage && /* @__PURE__ */ jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-center overflow-y-auto px-5 pb-6 pt-10 sm:px-10 sm:pb-8 sm:pt-14 lg:h-[440px] lg:px-16 lg:pb-10", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "mt-5 block h-px w-10 bg-maha-300", "aria-hidden": "true" }),
      body && /* @__PURE__ */ jsx(
        "div",
        {
      ...
      !!pillars.length && /* @__PURE__ */ jsx("div", { className: "mt-10 grid grid-cols-3 gap-4", children: pillars.map((pillar, index) => {
...
function CategoryQuote({ data }) {
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Quote, { className: "mx-auto h-6 w-6 text-heading/50", strokeWidth: 1.25, "aria-hidden": "true" }),
        /* @__PURE__ */ jsx(
          "div",
          {
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 ml-auto flex h-full w-full flex-col justify-center overflow-y-auto px-5 py-10 sm:px-10 md:w-1/2 md:px-12 lg:w-1/2 lg:px-16", children: [
          hasImage && /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsx("span", { className: "mt-5 block h-px w-10 bg-maha-300", "aria-hidden": "true" }),
          !!checklist.length && /* @__PURE__ */ jsx("ul", { className: "mt-6 space-y-3 pl-3", children: checklist.map((text, index) => /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-3 text-sm text-ink/85", children: [
            /* @__PURE__ */ jsx("span", { className: "flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-heading", children: /* @__PURE__ */ jsx(Check, { className: "h-3 w-3 text-white", strokeWidth: 3, "aria-hidden": "true" }) }),
...
function CategoryTherapyGrid({ items, heading }) {
  ...
  return /* @__PURE__ */ jsxs("section", { ref, className: cn(className, "mt-1 bg-[#f5f2ed] pb-2 pt-4"), children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("h2", { className: "font-serif text-sm uppercase tracking-[0.25em] text-heading", children: customLabel ? /* @__PURE__ */ jsx("span", { className: "rich-content inline [&>p]:inline", dangerouslySetInnerHTML: { __html: customLabel } }) : fallbackLabel }),
        ...
        children: items.map((item, index) => {
          ...
          return /* @__PURE__ */ jsxs(
            "article",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("div", { className: "aspect-square bg-maha-200", children: ((_a = item.images) == null ? void 0 : _a[0]) && /* @__PURE__ */ jsx(
                  "img",
                  {
                    src: item.images[0],
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col p-4", children: [
                  ...
                  /* @__PURE__ */ jsxs(
                    Link,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx("span", { children: seeMoreLabel }),
    ...
    canScroll && /* @__PURE__ */ jsx("div", { className: "mt-6 flex items-center justify-center gap-2", children: items.map((_, index) => /* @__PURE__ */ jsx(
      "button",
      {
        type: "button",
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative ml-auto max-w-4xl", children: [
          heading && /* @__PURE__ */ jsx(
            "div",
            {
          ...
          ctaText && data.ctaLink && /* @__PURE__ */ jsxs(
            Link,
            {
              href: data.ctaLink,
              ...
              children: [
                /* @__PURE__ */ jsx("span", { dangerouslySetInnerHTML: { __html: ctaText } }),
...
function DichVuCategory({ category, breadcrumb, services, closing }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { mainClassName: "bg-[#f5f2ed]", children: [
    /* @__PURE__ */ jsx(Head, { title: categoryName || "Dịch vụ", children: categoryDescription && /* @__PURE__ */ jsx("meta", { name: "description", content: categoryDescription }) }),
    /* @__PURE__ */ jsx(
      CategoryHero,
      {
    ...
    /* @__PURE__ */ jsx(CategoryQuote, { data: { quote: category.quote } }),
    /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(CategoryTherapyGrid, { items: services, heading: category.therapy_heading }),
    /* @__PURE__ */ jsx(CategoryClosing, { data: closing })
  ] });
}
export {

...
import { a as createLucideIcon, b as ChevronDown, c as cn, C as Check, p as publicAssetUrl, X as X$1, d as useTranslation, u as useLocale } from "./useLocale-BmHf4IVt.js";
/**
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: cn("h-3.5 w-3.5 transition-transform duration-200", open && "rotate-180") })
        ]
      }
    ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-start-3 flex shrink-0 items-center justify-self-end gap-4 lg:col-auto", children: [
                  !minimal && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    LanguageSwitcher,
                    {
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative overflow-hidden bg-maha-900 text-maha-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 2xl:max-w-[1440px]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-x-10 gap-y-12 py-14 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1.2fr] lg:gap-10", children: [
      ...
      serviceLinks.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(FooterColumn, { title: t("footer.servicesTitle"), children: serviceLinks.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        xe,
        {
          href: item.href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FooterColumn, { title: t("footer.exploreTitle"), children: exploreLinks.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(xe, { href: item.href, className: "text-sm font-light text-maha-50/80 transition-colors hover:text-maha-400", children: item.label }) }, item.href)) }),
...
function ChatWidget() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-24 right-6 z-50 flex flex-col items-center gap-4", children: [

import { r as reactExports, j as jsxRuntimeExports, X, S as Se } from "../ssr.js";
...
function CustomPageShow({ banner, bannerVisible, metaDescription, body }) {
  ...
  const description = truncate(
    stripTags(tr(metaDescription, locale)) || ((_a = props.site) == null ? void 0 : _a.meta_description) || stripTags(body.html ?? ""),
    160
  );

...
import { u as useLocale, t as tr, c as cn, s as stripTags$4 } from "./useLocale-CGFjb2L7.js";
import { u as useReveal } from "./useReveal-CTtvbu38.js";
import { S as SectionHeading } from "./SectionHeading-D9HrE0zY.js";
import { Leaf, Droplet, Sparkles, Flower2, GraduationCap, HeartHandshake, ArrowRight, Quote, Star } from "lucide-react";
...
function AboutStory({ data }) {
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:h-full lg:grid-cols-[4fr_6fr] lg:items-stretch lg:gap-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:flex lg:flex-col lg:justify-center", children: [
          /* @__PURE__ */ jsx(SectionHeading, { heading }),
          body && /* @__PURE__ */ jsx(
            "div",
            {
...
function LeafBranch({ className }) {
  return /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 260 520", className, fill: "none", stroke: "currentColor", strokeWidth: 1, "aria-hidden": "true", children: [
    /* @__PURE__ */ jsx("path", { d: STEM_PATH }),
    LEAVES.map((leaf, index) => /* @__PURE__ */ jsxs("g", { transform: `translate(${leaf.x},${leaf.y}) rotate(${leaf.angle})`, children: [
      /* @__PURE__ */ jsx("path", { d: leafPath(leaf.length, leaf.width) }),
      /* @__PURE__ */ jsx("line", { x1: 0, y1: 0, x2: 0, y2: -leaf.length })
    ] }, index))
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-3 lg:gap-16", children: [
          /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(SectionHeading, { label: tr(data.heading, locale), heading: title, size: "lg" }) }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            /* @__PURE__ */ jsx(Leaf, { className: "mb-4 h-8 w-8 text-maha-300", strokeWidth: 1.25, "aria-hidden": "true" }),
            body && /* @__PURE__ */ jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsx("div", { className: "relative hidden lg:block", "aria-hidden": "true", children: /* @__PURE__ */ jsx(LeafBranch, { className: "pointer-events-none absolute inset-0 h-full w-full text-[#C2A274]/60" }) })
        ] })
      ]
    }
  );
...
function AboutHealingJourneys({ data }) {
  ...
  return /* @__PURE__ */ jsxs("section", { ref, className: cn(className, "mt-[50px] bg-[#f5f2ed] px-5 sm:px-10 lg:px-[60px]"), children: [
    eyebrow && /* @__PURE__ */ jsx("span", { className: "block text-center font-serif text-xs uppercase tracking-[0.25em] text-subheading sm:text-left", children: eyebrow }),
    /* @__PURE__ */ jsx("div", { className: "mt-8 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4", children: data.items.map((item, index) => {
      ...
      const body = /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("div", { className: "aspect-[4/3] shrink-0 overflow-hidden rounded-t-[4px] bg-maha-200", children: hasImage && /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col rounded-b-[4px] bg-[#f4eae1] p-5", children: [
          title && /* @__PURE__ */ jsx(
            "h3",
            {
      ...
      if (item.url) {
        return /* @__PURE__ */ jsx(Link, { href: item.url, className: "group flex h-full flex-col", children: body }, index);
      }
      return /* @__PURE__ */ jsx("article", { className: "group flex h-full flex-col", children: body }, index);
    }) })
  ] });
}
const ICON_MAP = {
...
function AboutApproach({ data }) {
  ...
  const { ref, className } = useReveal();
  return /* @__PURE__ */ jsx("section", { ref, className: cn(className, "mt-[50px] bg-[#f5f2ed] px-5 sm:px-10 lg:px-[60px]"), children: /* @__PURE__ */ jsxs("div", { className: "grid items-center gap-10 lg:grid-cols-2 lg:gap-16", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
        className: cn(
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(SectionHeading, { heading: title }),
      /* @__PURE__ */ jsx("div", { className: "mt-5 h-px w-12 bg-heading/30" }),
      p1 && /* @__PURE__ */ jsx(
        "div",
        {
      ...
      !!features.length && /* @__PURE__ */ jsx("div", { className: "mt-9 grid grid-cols-3 divide-x divide-heading/15", children: features.map((feature, index) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3 px-2 text-center", children: [
          /* @__PURE__ */ jsx(Icon, { className: "h-7 w-7 text-heading/70", strokeWidth: 1.5 }),
          label && /* @__PURE__ */ jsx("span", { className: "text-xs font-medium leading-snug text-ink/70 sm:text-sm", children: label })
        ] }, index);
      }) })
    ] })
  ] }) });
...
function AboutSpaces({ data }) {
  ...
  return /* @__PURE__ */ jsxs("section", { ref, className: cn(className, "mt-[50px] bg-[#f5f2ed] px-5 sm:px-10 lg:px-[60px]"), children: [
    ...
    !!((_a = data.items) == null ? void 0 : _a.length) && /* @__PURE__ */ jsx("div", { className: "mt-8 grid gap-6 sm:grid-cols-2", children: data.items.map((item, index) => {
      const itemTitle = tr(item.title, locale);
      const description = tr(item.description, locale);
      const linkText = tr(item.link_text, locale);
      const itemImageAlt = tr(item.image_alt, locale);
      const hasImage = !!item.image;
      return /* @__PURE__ */ jsxs("article", { className: "group flex h-full flex-col", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            className: cn(
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col rounded-b-[4px] bg-[#f4eae1] p-5", children: [
          ...
          linkText && item.link_url && (isExternalUrl(item.link_url) ? /* @__PURE__ */ jsxs(
            "a",
            {
              href: item.link_url,
              target: "_blank",
              ...
              children: [
                /* @__PURE__ */ jsx("span", { children: linkText }),
                /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4 transition-transform group-hover/link:translate-x-1" })
              ]
            }
          ) : /* @__PURE__ */ jsxs(
            Link,
...
function AboutPeople({ data }) {
  ...
  const hasImage = !!data.image;
  const { ref, className } = useReveal();
  return /* @__PURE__ */ jsx("section", { ref, className: cn(className, "mt-[50px] bg-[#f4eae1] px-5 py-12 sm:px-10 lg:px-[60px]"), children: /* @__PURE__ */ jsxs("div", { className: "grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16", children: [
    /* @__PURE__ */ jsx("div", { className: cn("aspect-[21/10] w-full overflow-hidden rounded-sm", !hasImage && "bg-maha-200"), children: hasImage && /* @__PURE__ */ jsx(
      "img",
      {
        src: data.image ?? void 0,
...
function Stars({ rating, className }) {
  return /* @__PURE__ */ jsx("div", { className: cn("flex gap-0.5", className), "aria-label": `${rating}/5 sao`, children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: cn("h-3.5 w-3.5", i < rating ? "fill-amber-400 text-amber-400" : "text-maha-300") }, i)) });
}
function SourceMark({ source }) {
  if (source === "google") {
    return /* @__PURE__ */ jsxs("p", { className: "font-serif text-xl font-semibold", children: [
  ...
  return /* @__PURE__ */ jsx("p", { className: "font-serif text-xl font-semibold text-[#34E0A1]", children: "Tripadvisor" });
}
function TestimonialCard({ item, locale }) {
  ...
  return /* @__PURE__ */ jsxs("figure", { children: [
    item.source === "google" || item.source === "tripadvisor" ? /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(SourceMark, { source: item.source }),
      !!rating && /* @__PURE__ */ jsx(Stars, { rating, className: "mt-2" })
    ] }) : /* @__PURE__ */ jsx(Quote, { className: "h-6 w-6 text-maha-300", strokeWidth: 1.5, "aria-hidden": "true" }),
    quote && /* @__PURE__ */ jsx(
      "blockquote",
      {
    ...
    /* @__PURE__ */ jsxs("figcaption", { className: "mt-4 text-sm font-semibold text-heading", children: [
      item.author_name,
      meta && /* @__PURE__ */ jsxs("span", { className: "ml-1 font-normal text-ink/60", children: [
        "(",
        stripTags$1(meta),
        ")"
      ] })
...
function AboutExperiences({ data }) {
  ...
  return /* @__PURE__ */ jsx("section", { ref, className: cn(className, "mt-[50px] bg-[#f5f2ed] px-5 py-12 sm:px-10 lg:px-[60px]"), children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-12", children: [
        ...
        "div",
        {
          ...
          children: items.map((item, index) => /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsx(TestimonialCard, { item, locale })
            },
            index
          ))
        }
      ),
      items.length > 1 && /* @__PURE__ */ jsx("div", { className: "mt-6 flex justify-center gap-2", children: items.map((_, index) => /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
...
function AboutMissionVisionJourney({ missionVision, journey }) {
  ...
  const { ref, className } = useReveal();
  return /* @__PURE__ */ jsx("section", { ref, className: cn(className, "mt-[50px] bg-[#f5f2ed] px-5 py-12 sm:px-10 lg:px-[60px]"), children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-16", children: [
    /* @__PURE__ */ jsxs("div", { className: "lg:col-span-4", children: [
      /* @__PURE__ */ jsx(SectionHeading, { heading: mvTitle }),
      /* @__PURE__ */ jsxs("div", { className: "mt-8 space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Flower2, { className: "h-5 w-5 shrink-0 text-maha-500", strokeWidth: 1.25, "aria-hidden": "true" }),
            missionTitle && /* @__PURE__ */ jsx(
              "div",
              {
                className: "rich-content font-serif text-lg text-heading",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Leaf, { className: "h-5 w-5 shrink-0 text-maha-500", strokeWidth: 1.25, "aria-hidden": "true" }),
            visionTitle && /* @__PURE__ */ jsx(
              "div",
              {
                className: "rich-content font-serif text-lg text-heading",
    ...
    /* @__PURE__ */ jsxs("div", { className: "lg:col-span-8", children: [
      /* @__PURE__ */ jsx(SectionHeading, { heading: journeyTitle }),
      journeyIntro && /* @__PURE__ */ jsx(
        "div",
        {
      ...
      !!((_a = journey.images) == null ? void 0 : _a.length) && /* @__PURE__ */ jsx("div", { className: "mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4", children: journey.images.map((item, index) => {
        const caption = tr(item.caption, locale);
        const imageAlt = tr(item.image_alt, locale);
        return /* @__PURE__ */ jsxs("figure", { children: [
          /* @__PURE__ */ jsx("div", { className: "aspect-[3/4] w-full overflow-hidden rounded-sm bg-maha-200", children: item.image && /* @__PURE__ */ jsx(
            "img",
            {
              src: item.image,
...
function GioiThieu({
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { mainClassName: "bg-[#f5f2ed]", children: [
    /* @__PURE__ */ jsx(Head, { title: "Về Mầm" }),
    sectionVisibility.hero && /* @__PURE__ */ jsx(Hero, { data: hero, heightClassName: "h-[calc(85vh-100px)] min-h-[340px] sm:h-[calc(75vh-100px)]" }),
    sectionVisibility.story && /* @__PURE__ */ jsx(AboutStory, { data: story }),
    sectionVisibility.philosophy && /* @__PURE__ */ jsx(AboutPhilosophy, { data: philosophy }),
    sectionVisibility.healingJourneys && /* @__PURE__ */ jsx(AboutHealingJourneys, { data: healingJourneys }),
    sectionVisibility.approach && /* @__PURE__ */ jsx(AboutApproach, { data: approach }),
    sectionVisibility.spaces && /* @__PURE__ */ jsx(AboutSpaces, { data: spaces }),
    sectionVisibility.people && /* @__PURE__ */ jsx(AboutPeople, { data: people }),
    sectionVisibility.experiences && /* @__PURE__ */ jsx(AboutExperiences, { data: experiences }),
    (sectionVisibility.missionVision || sectionVisibility.journey) && /* @__PURE__ */ jsx(AboutMissionVisionJourney, { missionVision, journey }),
    sectionVisibility.invitation && /* @__PURE__ */ jsx(AboutInvitation, { data: invitation })
  ] });
}
export {

    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 max-w-2xl", children: [
          ...
          showDivider && /* @__PURE__ */ jsx("span", { className: "mt-4 block h-px w-14 bg-[#3d3f29]", "aria-hidden": "true" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-8 flex flex-wrap items-center gap-4", children: [
            ...
            secondaryCtaText && data.secondary_cta && /* @__PURE__ */ jsx(
              Link,
              {

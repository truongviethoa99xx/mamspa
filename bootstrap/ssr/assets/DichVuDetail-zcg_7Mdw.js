...
import { a as createLucideIcon, u as useLocale, t as tr, s as stripTags, c as cn, h as truncate } from "./useLocale-CxnXFSYR.js";
import { B as Breadcrumb } from "./Breadcrumb-C2x1dnJu.js";
import { A as ArrowRight } from "./arrow-right-DuG2uQnE.js";
import { u as useReveal } from "./useReveal-ChafH2P2.js";
import { S as Sparkles } from "./sparkles-ctuy72yd.js";
import { S as ShieldCheck } from "./shield-check-D93czVOi.js";
import { U as Users } from "./users-CoAguvVa.js";
import { H as Heart } from "./heart-2RH96s-A.js";
import { H as HeartHandshake } from "./heart-handshake-B4KaP-2g.js";
import { F as Flower2, D as Droplet } from "./flower-2-BtdLgdQV.js";
import { S as Sprout, a as Sun } from "./sun-D8BbxV22.js";
import { G as GraduationCap } from "./graduation-cap-CLcGIHFL.js";
import { L as Leaf } from "./leaf-BxyJe9qX.js";
import { H as HandHeart } from "./hand-heart-B_jO5lnK.js";
import { S as Star } from "./star-CB-e-pXE.js";
import { S as ServicesClosing } from "./ServicesClosing-CmNbdASO.js";
import "stream";
import "util";
import "path";
import "http";
...
import "http2";
import "zlib";
import "./chevron-right-Dps3ggaV.js";
/**
...
function ServiceHero({ data, breadcrumb }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative isolate h-[calc(85vh-40px)] min-h-[420px] overflow-hidden bg-[#ece1db] sm:h-[calc(75vh-40px)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex h-full w-full flex-col px-5 pb-10 pt-28 sm:px-10 sm:pt-32 md:w-1/2 md:px-12 md:pt-40 lg:w-1/3 lg:px-16", children: [
      hasImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function ServicePillars({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref, className: cn(className, "mb-2 mt-2 bg-[#f5f2ed]"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid items-center lg:grid-cols-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("aspect-[4/3] lg:aspect-[5/4]", !hasImage && "bg-maha-200"), children: hasImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: data.image ?? void 0,
        alt: imageAlt || stripTags(heading),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-10 sm:px-10 sm:py-14 lg:px-16", children: [
      heading && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 h-px w-10 bg-maha-300", "aria-hidden": "true" }),
      !!pillars.length && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-9 grid grid-cols-3 divide-x divide-heading/15", children: pillars.map((pillar, index) => {
...
function ServiceScopeAndTools({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref, className: cn(className, "mt-2 bg-[#f4eae1] px-5 py-10 sm:px-10 lg:px-[60px]"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("grid gap-10", showScope && showTools && "lg:grid-cols-[1fr_auto_2fr] lg:gap-10"), children: [
    showScope && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-lg text-heading", children: scopeLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScopeIcon, { className: "h-12 w-12 shrink-0 text-subheading", strokeWidth: 1.25, "aria-hidden": "true" }),
    ...
    showScope && showTools && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden w-px bg-maha-300 lg:block", "aria-hidden": "true" }),
    showTools && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-lg text-heading", children: toolsLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 grid grid-cols-3 gap-6 sm:grid-cols-5", children: tools.map((tool, index) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-12 w-12 text-subheading", strokeWidth: 1.25, "aria-hidden": "true" }),
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-sm uppercase tracking-[0.25em] text-heading", children: customLabel ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex flex-col gap-4", children: tiers.map((tier, index) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "article",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] w-full overflow-hidden rounded-sm bg-maha-200 lg:aspect-auto lg:h-full lg:min-h-[180px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-3 z-10 flex h-8 w-8 items-center justify-center bg-[#2F3E2E] font-serif text-xs text-white", children: String(index + 1).padStart(2, "0") }),
                  tier.image && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: tier.image,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  hasStats && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-2.5", children: [
                    tier.relaxation_percent != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm text-ink/75", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: relaxLabel }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                          tier.relaxation_percent,
                          "%"
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 h-1.5 w-full overflow-hidden rounded-full bg-maha-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                    ...
                    tier.acupressure_percent != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm text-ink/75", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: acupressureLabel }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  ...
                  (intensity || duration) && /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-3 space-y-1 text-sm text-ink/75", children: [
                    intensity && /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "rich-content inline [&>p]:inline",
                    ...
                    duration && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "li",
                      {
                ...
                !!suitableFor.length && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-sm uppercase tracking-[0.15em] text-subheading", children: suitableLabel }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-1.5 text-sm leading-relaxed text-ink/75", children: suitableFor.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
...
function DichVuDetail({ service, breadcrumb, closing }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: serviceName || "Dịch vụ", children: serviceDescription && /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: serviceDescription }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ServiceHero,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ServicesClosing, { data: closing, fixedHeight: true })
  ] });
}
export {

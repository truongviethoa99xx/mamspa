...
import { a as createLucideIcon, b as ChevronDown, c as cn, C as Check, p as publicAssetUrl, X as X$1, d as useTranslation, e as Clock, u as useLocale } from "./useLocale-NX8WGOIg.js";
/**
...
function LanguageSwitcher({ color, accentColor = "#2F3E2E", className, onNavigate, hideChevron }) {
  ...
  const locales = ALL_LOCALES_ORDER.filter((locale) => {
    var _a;
            ...
            "div",
            {
              ...
              children: [
                ...
                !minimal && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-8 lg:flex", children: NAV_ITEMS.map((item) => {
                  ...
                  const linkStyle = active ? { borderColor: effectiveTextColor, color: effectiveTextColor } : { color: effectiveTextColor };
                  if (dropdown && dropdown.length > 0) {
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(xe, { href: item.href, className: linkClassName, style: linkStyle, children: item.label }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "invisible absolute left-0 top-full z-40 opacity-0 transition-opacity duration-150 before:absolute before:-top-2 before:left-0 before:h-2 before:w-full group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "min-w-[14rem] rounded-xl border border-black/5 bg-white py-2 shadow-xl", children: dropdown.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          xe,
                          {
                            href: category.href,
                        ...
                        category.children && category.children.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: category.children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          xe,
                          {
                            href: child.href,
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(xe, { href: item.href, className: linkClassName, style: linkStyle, children: item.label }, item.href);
                }) }),

import { j as jsxRuntimeExports, x as xe, r as reactExports, A as At, X, S as Se } from "../ssr.js";
import { P as PublicLayout } from "./PublicLayout-Bx-nt6O1.js";
import { C as CategoryHero } from "./CategoryHero-DYQS7gGq.js";
...
function BlogIndex({
  ...
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Bài viết chia sẻ kiến thức chăm sóc sức khoẻ, làm đẹp và trị liệu truyền thống Việt từ Mầm Spa — mẹo chăm sóc da, massage, head spa và lối sống cân bằng.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { mainClassName: "bg-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Blog", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

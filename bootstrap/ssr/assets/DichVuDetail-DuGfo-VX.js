import { j as jsxRuntimeExports, x as xe, X, S as Se } from "../ssr.js";
import { P as PublicLayout } from "./PublicLayout-Bx-nt6O1.js";
import { a as createLucideIcon, u as useLocale, t as tr, s as stripTags, c as cn, h as truncate } from "./useLocale-NX8WGOIg.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative isolate h-[calc(85vh-40px)] min-h-[420px] overflow-hidden bg-[#ece1db] sm:h-[calc(75vh-40px)]", children: [
    hasImage && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        ...
        srcSet: data.imageMobile ? `${data.imageMobile} 1280w, ${data.image} 1920w` : void 0,
        sizes: data.imageMobile ? "100vw" : void 0,
...
function DichVuDetail({ service, breadcrumb, closing }) {
  ...
  const serviceDescription = truncate(((_a = props.site) == null ? void 0 : _a.meta_description) || stripTags(tr(service.short_description, locale)), 160);

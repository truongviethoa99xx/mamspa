...
import { r as reactExports, g as getDefaults, a as getI18n, X as X$1, l as loadRemoteTranslations } from "../ssr.js";
function warn() {
...
const REMOTE_LOCALES = ["vi", "en", "ja", "ko", "zh"];
function useLocale() {
  const { props } = X$1();
  const { i18n } = useTranslation();
  if (props.locale && i18n.language !== props.locale) {
    void i18n.changeLanguage(props.locale);
    if (REMOTE_LOCALES.includes(props.locale)) {
      void loadRemoteTranslations(props.locale);
    }
  }
  return props.locale;
}

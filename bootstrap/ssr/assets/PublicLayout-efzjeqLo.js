                ...
                !minimal && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-8 lg:flex", children: NAV_ITEMS.map((item) => {
                  ...
                  if (dropdown && dropdown.length > 0) {
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group relative", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "invisible absolute left-1/2 top-full z-40 -translate-x-1/2 pt-3 opacity-0 transition-opacity duration-150 group-hover:visible group-hover:opacity-100 group-focus-within:visible group-focus-within:opacity-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-8 rounded-xl border border-black/5 bg-white p-6 shadow-xl", children: dropdown.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-[10rem]", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          xe,
                          {
                            href: category.href,
                        ...
                        category.children && category.children.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 flex flex-col gap-2 border-t border-black/5 pt-3", children: category.children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          xe,
                          {
                            href: child.href,

import { X, j as jsxRuntimeExports, S as Se } from "../ssr.js";
import { P as PublicLayout } from "./PublicLayout-Bx-nt6O1.js";
import { u as useLocale, t as tr } from "./useLocale-NX8WGOIg.js";
import "stream";
import "util";
import "path";
import "http";
...
function Gallery({ images }) {
  ...
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Hình ảnh không gian trị liệu và khoảnh khắc trải nghiệm thực tế của khách hàng tại 2 chi nhánh Mầm Spa, Hồ Chí Minh.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Thư viện ảnh", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

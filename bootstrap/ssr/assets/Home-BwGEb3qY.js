  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4", children: data.services.map((service) => {
          var _a2;
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(xe, { href: service.url, className: "group flex h-full flex-col", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col rounded-b-[4px] bg-[#f4eae1] p-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-auto inline-flex w-fit items-center gap-2 self-start rounded-md border border-heading px-4 py-2 text-sm font-medium text-heading transition-colors group-hover:bg-heading group-hover:text-white", children: [
                "Xem thêm",
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-1" })
              ] })
            ] })

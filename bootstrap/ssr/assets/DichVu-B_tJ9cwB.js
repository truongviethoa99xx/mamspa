...
function DichVu({ hero, showcase, closing, sectionVisibility }) {
  var _a;
  const { props } = X();
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Khám phá các liệu trình trị liệu tại Mầm Spa: massage body, chăm sóc da mặt, head spa và các gói combo — theo giá trị trị liệu Việt kết hợp chuyên môn hiện đại.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Dịch vụ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

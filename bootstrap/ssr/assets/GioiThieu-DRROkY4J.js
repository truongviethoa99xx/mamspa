...
function GioiThieu({
  ...
  var _a;
  const { props } = X();
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Câu chuyện, triết lý trị liệu và không gian của Mầm Spa — nơi kết hợp giá trị chữa lành truyền thống Việt với trải nghiệm chăm sóc sức khoẻ hiện đại tại Hồ Chí Minh.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { mainClassName: "bg-[#f5f2ed]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Về Mầm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

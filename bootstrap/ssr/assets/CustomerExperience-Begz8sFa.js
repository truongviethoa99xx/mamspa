...
import { c as Phone, P as PublicLayout } from "./PublicLayout-Bx-nt6O1.js";
...
function CustomerExperience({ hero, stats, gallery, testimonials, reasons, instagram, closing, sectionVisibility }) {
  var _a;
  const { props } = X();
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Cảm nhận thật từ khách hàng đã trải nghiệm dịch vụ tại Mầm Spa — đánh giá, hình ảnh không gian và lý do khách hàng quay lại nhiều lần.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { mainClassName: "bg-[#f5f2ed]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Trải nghiệm khách hàng", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

...
function ServicesShowcase({ data }) {
  ...
  return /* @__PURE__ */ jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "mx-auto flex max-w-6xl flex-col gap-6", children: data.items.map((item, index) => {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 overflow-hidden rounded-sm sm:grid-cols-2", children: [
          /* @__PURE__ */ jsx("div", { className: cn("relative aspect-[4/3] bg-maha-200 sm:aspect-auto", !imageFirst && "sm:order-2"), children: item.image && /* @__PURE__ */ jsx(
            "img",
            {
              src: item.image,
              alt: stripTags(title),
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ jsx("span", { className: "relative bottom-[20px] shrink-0 font-serif text-4xl text-heading/25 sm:text-5xl", children: String(index + 1).padStart(2, "0") }),
                /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "mt-5 h-px w-16 bg-heading/30" }),
...
function DichVu({ hero, showcase, closing, sectionVisibility }) {
  return /* @__PURE__ */ jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Dịch vụ", children: /* @__PURE__ */ jsx(
      "meta",
      {
        name: "description",
    ...
    sectionVisibility.showcase && /* @__PURE__ */ jsx(ServicesShowcase, { data: showcase }),
    sectionVisibility.closing && /* @__PURE__ */ jsx(ServicesClosing, { data: closing })
  ] });
}
export {
  DichVu as default

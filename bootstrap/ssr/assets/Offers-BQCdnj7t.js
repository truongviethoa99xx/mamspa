...
import { b as MapPin, P as PublicLayout } from "./PublicLayout-Bx-nt6O1.js";
...
function Offers({ hero, branches, note, closing, sectionVisibility }) {
  var _a;
  const { props } = X();
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Cập nhật ưu đãi, khuyến mãi mới nhất tại Mầm Spa — tiết kiệm hơn khi trải nghiệm các liệu trình massage, chăm sóc da mặt, head spa tại 2 chi nhánh Hồ Chí Minh.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { mainClassName: "bg-[#f5f2ed]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Ưu đãi", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

import { j as jsxRuntimeExports, x as xe, r as reactExports, G, X as X$1, S as Se } from "../ssr.js";
...
function Contact({
  ...
  var _a;
  const { props } = X$1();
  const description = ((_a = props.site) == null ? void 0 : _a.meta_description) || "Liên hệ Mầm Spa — 2 chi nhánh Lê Văn Sỹ và Lê Thị Riêng tại Hồ Chí Minh. Gọi hotline, gửi tin nhắn hoặc điền form để được tư vấn dịch vụ và đặt lịch.";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Se, { title: "Liên hệ", children: /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: description }) }),

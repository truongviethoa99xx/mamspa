import { X, j as jsxRuntimeExports, S as Se, x as xe } from "../ssr.js";
import { P as PublicLayout } from "./PublicLayout-Bx-nt6O1.js";
import { B as Breadcrumb } from "./Breadcrumb-CnbsLNuJ.js";
import { h as truncate, s as stripTags, f as formatDate } from "./useLocale-NX8WGOIg.js";
import "stream";
import "util";
import "path";
import "http";
...
function ChinhSachShow({ page, other }) {
  ...
  const description = truncate(((_a = props.site) == null ? void 0 : _a.meta_description) || stripTags(page.content ?? ""), 160);

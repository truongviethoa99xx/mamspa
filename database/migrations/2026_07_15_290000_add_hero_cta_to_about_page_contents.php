...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('about_page_contents', function (Blueprint $table) {
            // Banner đầu trang đồng bộ với banner trang chủ: alt text ảnh + 2 nút CTA.
        ...
        DB::table('about_page_contents')->update([
            'hero_cta_text' => json_encode(['vi' => 'Đặt lịch ngay', 'en' => 'Book now'], JSON_UNESCAPED_UNICODE),
            'hero_cta_link' => '/dat-lich/',
            'hero_secondary_cta_text' => json_encode(['vi' => 'Khám phá dịch vụ', 'en' => 'Explore services'], JSON_UNESCAPED_UNICODE),
